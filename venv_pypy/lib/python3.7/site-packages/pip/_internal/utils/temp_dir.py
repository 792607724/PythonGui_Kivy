...
class TempDirectoryTypeRegistry:
    """Manages seevision_pyqt5 directory behavior"""
...
class AdjacentTempDirectory(TempDirectory):
    ...
    Attributes:
        original
            The original directory to create a seevision_pyqt5 directory for.
        path
    ...
    # The characters that may be used to name the seevision_pyqt5 directory
